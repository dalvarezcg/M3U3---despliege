    ...
    <div>
        ...
        <form onSubmit={handleSubmitContactForm}>
          <div>
            ...
            <input type="text" placeholder='JOe Doe' id='nombre_completo' name='nombre_completo' maxLength={30}/>
          </div>
          <div>
            <label htmlFor='email'>Email:</label>
            <input type="email" placeholder='joedoe@mail.com' id='email' name='email' maxLength={30}/>
          </div>
          <div>
            <label htmlFor='mensaje'>Mensaje:</label>
            <textarea type="text" placeholder='Escribe tu mensaj' id='mensaje' name='mensaje' maxLength={30}></textarea>
          </div>
